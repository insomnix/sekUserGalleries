...
class sekugUserSettingsGetListProcessor extends modObjectGetListProcessor {
    public $classKey = 'sekugUserSettings';
    public $languageTopics = array('sekugusergalleries:default');
    public $defaultSortField = 'gallery_user';
	...
	public function prepareQueryBeforeCount(xPDOQuery $c) {
		...
		if (!empty($query)) {
			$c->where(array(
				'gallery_user:LIKE' => '%'.$query.'%',
			));
		}
		return $c;
	}
}
return 'sekugUserSettingsGetListProcessor';