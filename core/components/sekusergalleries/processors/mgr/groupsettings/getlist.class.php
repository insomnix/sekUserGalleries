...
class sekugGroupSettingsGetListProcessor extends modObjectGetListProcessor {
    public $classKey = 'sekugGroupSettings';
    public $languageTopics = array('sekugusergalleries:default');
    public $defaultSortField = 'usergroup';
	...
	public function prepareQueryBeforeCount(xPDOQuery $c) {
		...
		if (!empty($query)) {
			$c->where(array(
				'usergroup:LIKE' => '%'.$query.'%',
			));
		}
		return $c;
	}
}
return 'sekugGroupSettingsGetListProcessor';